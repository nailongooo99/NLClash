...
final unixSocketPath = '/tmp/NLClashSocket_${Random().nextInt(10000)}.sock';
final windowsPipeName = '\\\\.\\pipe\\NLClashCore_${_randomPipeId()}';
const helperPort = 47890;
const helperProtocolVersionHeader = 'x-nlclash-helper-protocol';
...
const mainIsolate = 'NLClashMainIsolate';

const serviceIsolate = 'NLClashServiceIsolate';
